...
mixin _$Country {
 ...
 String get commonName; String get officialName;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Country&&(identical(other.commonName, commonName) || other.commonName == commonName)&&(identical(other.officialName, officialName) || other.officialName == officialName));
}
...
@useResult
$Res call({
 String commonName, String officialName
});
...
/// Create a copy of Country
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? commonName = null,Object? officialName = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String commonName,  String officialName)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Country() when $default != null:
return $default(_that.commonName,_that.officialName);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String commonName,  String officialName)  $default,) {final _that = this;
switch (_that) {
case _Country():
return $default(_that.commonName,_that.officialName);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String commonName,  String officialName)?  $default,) {final _that = this;
switch (_that) {
case _Country() when $default != null:
return $default(_that.commonName,_that.officialName);case _:
  return null;
...
class _Country implements Country {
  const _Country({required this.commonName, required this.officialName});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Country&&(identical(other.commonName, commonName) || other.commonName == commonName)&&(identical(other.officialName, officialName) || other.officialName == officialName));
}
...
/// Create a copy of Country
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? commonName = null,Object? officialName = null,}) {
